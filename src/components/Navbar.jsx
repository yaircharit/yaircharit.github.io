  ...
  return (
    <nav className={`navbar${scrolled ? ' scrolled' : ''}`}>
      ...
      <div className="right-section">
        <button className="dark-mode-toggle" onClick={() => setDark(d => !d)} title={dark ? 'Switch to light mode' : 'Switch to dark mode'} style={{ fontSize: '1.5rem', background: 'none', border: 'none', cursor: 'pointer', marginLeft: '1rem' }}>
          {dark ? (
